...
function startHeartbeat() {
    heartbeatInterval = setInterval(() => {
        if (gameRef) {
            const playerRef = gameRef.child('players').child(playerSymbol);
            playerRef.update({ lastActive: firebase.database.ServerValue.TIMESTAMP });
        }
